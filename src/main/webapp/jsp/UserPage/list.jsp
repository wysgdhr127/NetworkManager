...
<title>NetworkManager | UserList</title>
						...
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								<input type="button" class="btn btn-primary btn-sm"
									id="addButton"
									onclick='javascript:location.href="<%=path%>/admin/InAdd.action"'
									value="添加" />
									...
									<table id="searchtab"
										...
										<tbody id="listbody">
											<s:iterator value="resultList" id="show">
												<tr>
													<td></td>
													<td><s:property value="#show.username" /></td>
													<td><s:property value="#show.realName" /></td>
													<td><s:property value="#show.adminEmail" /></td>
													<td><s:property value="#show.functionPrivilege" /></td>
													<td><s:property value="#show.createTimeStr" /></td>
													<td><s:property value="#show.lastLoginTimeStr" /></td>
													<td><s:if test="status=='valid'">有效</s:if> <s:if
															test="status=='invalid'">无效</s:if></td>
													<td style="text-align: center;"><s:a action="InUpdate"
															namespace="/admin">
															<s:param name="vo.id">${id}</s:param>
															<span class="glyphicon glyphicon-pencil"></span>
														</s:a> <s:a action="Delete" namespace="/admin">
															<s:param name="vo.id">${id}</s:param>
