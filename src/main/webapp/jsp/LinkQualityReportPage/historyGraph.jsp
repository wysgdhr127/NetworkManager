...
<body>
	...
	<!-- HighstockJS-->
	<script type="text/javascript" src="${ctx}/js/plugins/Highstock/highstock.js"></script>
	<script type="text/javascript" src="${ctx}/js/plugins/Highstock/exporting.js"></script>
</body>
</html>